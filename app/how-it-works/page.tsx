...
const rules = [
  [
    '01',
    'ENTER THE AUCTION',
    'Choose one category. Put money behind your position. The highest total spend leads the global ladder.',
  ],
  [
    '02',
    'THE LADDER MOVES',
    'For twelve hours, anyone can outbid you. Every move is public, and position #1 has the biggest room.',
  ],
  [
    '03',
    'EXPOSURE LOCKS',
    'For twelve more hours, the final order is held in public view. Your position becomes the proof.',
  ],
];
  ...
  return (
    ...
    >
      ...
      <section className="route-panel schedule-panel">
        <div>
          <span className="eyebrow">00:00—12:00 UTC</span>
          <strong>AUCTION LIVE</strong>
          <p>Bid to move up.</p>
        </div>
        <div>
          <span className="eyebrow">12:00—00:00 UTC</span>
          <strong>LOCKED EXPOSURE</strong>
          <p>Hold the position.</p>
        </div>
        <div>
          <span className="eyebrow">00:00 UTC</span>
          <strong>THE DROP</strong>
          <p>The next room opens.</p>
        </div>
      </section>
    </MarketPageShell>
  );
