...
export default function DropPage() {
  ...
  function openSaved(id: string) {
    ...
    setError('');
    setNotice('');
    window.history.replaceState(null, '', `/drop?dropId=${id}`);
  }
  ...
  async function checkout() {
    ...
    try {
      ...
      const modal = new window.Razorpay({
        ...
        name: 'BOUGHT',
        description: 'Your global ladder position',
        theme: { color: '#ef2b32' },
          ...
          <section className="drop-workspace">
            ...
            {!queryReady || (loading && session) ? (
              ...
              <div className="drop-submitted">
                ...
                <Link className="drop-button primary" href="/ladder">
                  VIEW GLOBAL LADDER
              ...
              <>
                ...
                <p className="drop-fineprint">
                  <LockKeyhole size={13} />
                  Camera and microphone access unlock only after payment is
                  confirmed.
                </p>
              </>
            )}
